...
**DAO (Duality of Alpha and Omega)** is a mathematical logic framework that studies impossibility, diagonal arguments, and paradoxes. It is based on the interaction of three types:
...
From these extremes, DAO develops a logic based not on truth but on impossibility. DAO operates at a level of generality that allows existing math frameworks such as category theory and set theory to be embedded cleanly. The name *DAO* is an homage to Daoist metaphysics and non-duality, which unexpectedly mirrors the mathematical structure uncovered in Omega, Alpha, and Void.
...
* Explore compatibility with HoTT and the Coq-HoTT library
* Study impossibility geometry and topology
