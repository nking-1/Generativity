...
(* We'll have to use inductive types for the math to make Coq happy, but we'll rigorously map into
   the paradox constructions that we're actually trying to represent in the theory. *)
